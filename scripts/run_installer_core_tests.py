...
CORE_TESTS = (
    ...
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_managed_tree_source_must_exist_before_backup_or_runtime_write",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_managed_tree_source_must_contain_manifest_required_files",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_install_postflight_verifies_managed_tree_content_hashes",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_symlinked_managed_tree_destination_is_rejected_before_mirror",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_restore_swap_rolls_back_original_tree_if_replacement_rename_fails",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_backup_creation_rejects_empty_source_tree",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_secure_state_file_write_forces_requested_mode_on_existing_file",
    "installer.tests.unit.test_installer_hardening.InstallerHardeningTests.test_optimized_include_is_written_only_after_stock_homing_override_delete",
